...
import image from "@images/home/letsConnect/twitter.png";
  ...
  const socialMediaLinks = [
    {
      ...
      className:
        "hidden lg:block absolute hover:cursor-pointer top-14 left-14 xl:left-24 w-10 h-10 md:w-[210px] md:h-[210px] z-10",
      src: image,
      alt: "",
      width: 218,
      height: 218,
    ...
    },
    {
      ...
      tabIndex: 0,
      onClick: () =>
        window.open("https://www.instagram.com/shubhamcd2020/", "_blank"),
    },
    {
      initial: { y: -50, opacity: 0 },
      animate: inView ? { y: 0, opacity: 1 } : {},
      ...
      height: 168,
      tabIndex: 0,
      onClick: () => window.open("https://github.com/Shubhamk9798", "_blank"),
    },
    {
      initial: { y: -50, opacity: 0 },
      animate: inView ? { y: 0, opacity: 1 } : {},
    ...
    },
    {
      ...
      height: 310,
      tabIndex: 0,
      onClick: () => window.open("mailto:ashubhamk1997@gmail.com", "_self"),
    },
  ];
